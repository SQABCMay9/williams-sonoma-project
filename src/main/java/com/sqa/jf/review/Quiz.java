...
package com.sqa.jf.review;

/**
 * Quiz //ADDD (description of class)
 * <p>
...
public class Quiz {
	 ...
	 * 
	 * It's got the title of the question, the question itself and a mapping of
	 * answers to responses (where a response is the string the users sees, and
	...
	private static class QuizQuestion {
		...
		public QuizQuestion(final String iTitle, final String iQuestion) {
			...
			this.responses = new HashMap<Character, Pair<Boolean, String>>();
		}
		...
		public void addAnswer(final char letter, final String response, final boolean correct) {
			this.responses.put(Character.toLowerCase(letter), new Pair<Boolean, String>(correct, response));
		}
		...
		private Pair<Boolean, String> getPair(final char letter) {
			return this.responses.get(Character.toLowerCase(letter));
		}
	...
	public static void main(final String[] args) {
		...
		QuizQuestion q = new QuizQuestion("Question 1",
				"1. Which of the following is not a bright colour?\nA. Cyan\nB. Green\nC. Black\nD. Yellow\nAnswer: ");
		...
		q = new QuizQuestion("Question 2",
				"2. What genre does the singer John Legend sing in?\nA. Pop\nB. R&b\nC. Rap\nD. Rock\nAnswer: ");
		...
		/**
		 * Now you can do things here when they have answered all the questions
		 * correctly.
		 */
	}

	private static char poseQuestion(final QuizQuestion question) {
		final String ans = JOptionPane.showInputDialog(null, question.question, question.title,
	...
	private static void showResponse(final String response) {
		JOptionPane.showMessageDialog(null, response, "Answer CHECK!", JOptionPane.INFORMATION_MESSAGE);
	}
}
